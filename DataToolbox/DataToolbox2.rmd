...
https://campus.datacamp.com/courses/python-data-science-toolbox-part-2/using-iterators-in-pythonland?ex=4
...
import pandas as pd
result = []
for chunk in pd.read_csv('datamx.csv', chunksize = 1000):
